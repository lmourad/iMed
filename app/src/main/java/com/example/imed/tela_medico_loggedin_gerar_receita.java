            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if(textView_nome_remedio.getText().toString().equals("") || textView_cpf_do_paciente.getText().toString().equals("") ||
                        ...
                        Toast.makeText(tela_medico_loggedin_gerar_receita.this, "Há campos vazios!", Toast.LENGTH_SHORT).show();
                    }
                        ...
                        if(textView_cpf_do_paciente.getText().toString().equals(dao.retornaCPF(textView_cpf_do_paciente.getText().toString()))){
                            ...
                            Toast.makeText(tela_medico_loggedin_gerar_receita.this, "Receita criada com sucesso", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(tela_medico_loggedin_gerar_receita.this, tela_medico_loggedin.class);
                            startActivity(intent);
                        }
                        else{
                            Toast.makeText(tela_medico_loggedin_gerar_receita.this, "CPF Ínvalido", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else{
                        Toast.makeText(tela_medico_loggedin_gerar_receita.this, "CPF Ínvalido", Toast.LENGTH_SHORT).show();
