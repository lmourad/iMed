...
import com.example.imed.Telas.TelasPaciente.tela_paciente_inicio;

public class tela_zexcluir_paciente_meus_medicamentos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_zexcluir_paciente_meus_medicamentos);
        ...
        imageButton_go_back_meus_medicamentos_to_paciente_loggedin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(tela_zexcluir_paciente_meus_medicamentos.this, tela_paciente_inicio.class);
        ...
        button_procurar_meus_medicamentos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tela_zexcluir_paciente_meus_medicamentos.this, tela_lista_meus_medicamentos.class);
                startActivity(intent);
            }
        });
    }
